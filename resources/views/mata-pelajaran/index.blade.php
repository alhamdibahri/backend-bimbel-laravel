			...
			<div class="table-responsive">
				...
				<tbody>
					...
					@foreach($data_mata_pelajaran as $mata_pelajaran)
						<tr>
							<td>{{ $no++ }}</td>
							<td>{{ $mata_pelajaran->categoriKelas->nama_category_kelas }}</td>
							<td>{{ $mata_pelajaran->mata_pelajaran }}</td>
							<td align="center">
                                <div class="box-button">
                                    <a href="{{ url('mata-pelajaran/edit/'. $mata_pelajaran->id_mata_pelajaran) }}" class="btn btn-primary"><i class="fas fa-edit"></i></a>
                                </div>
                                <div class="box-button">
                                    <a href="{{ url('mata-pelajaran/destroy/'. $mata_pelajaran->id_mata_pelajaran) }}" class="btn btn-danger confirm_delete"><i class="fas fa-trash"></i></a>
                                </div>
							</td>
						</tr>
					@endforeach
