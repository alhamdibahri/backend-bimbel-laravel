...
<div class="container-fluid">
	<div class="row">
		<div class="col-12">
			<div class="card">
            {!!  Form::model($mata_pelajaran, ['method' =>  'PATCH', 'action' => ['MataPelajaranController@update', $mata_pelajaran->id_mata_pelajaran], 'class' => 'form-horizontal']) !!}
				@include('mata-pelajaran.form', ['submitButtonText' => 'Update'])
			{!! Form::close() !!}
            </div>
		</div>
	</div>
