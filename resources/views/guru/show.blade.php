                            ...
                            <div class="d-flex justify-content-start">
                                <div class="image-container">
                                    @if(isset($guru->guru['foto_guru']))
                                        <img src="{{ asset('fotoguru/'. $guru->guru['foto_guru']) }}" id="imgProfile" style="width: 150px; height: 150px" class="img-thumbnail" />
                                    @else
                                        @if($guru->guru['jenkel_guru'] == 'Pria')
                                            <img src="{{ asset('fotoguru/male.png') }}" id="imgProfile" style="width: 150px; height: 150px" class="img-thumbnail" />
                                        @else
                                            <img src="{{ asset('fotoguru/female.png') }}" id="imgProfile" style="width: 150px; height: 150px" class="img-thumbnail" />
                                        @endif
                                    @endif
                                </div>
                                <div class="userData ml-3">
                                    <h2 class="d-block" style="font-size: 1.5rem; font-weight: bold">{{ $guru->nama }}</h2>
                                    <h6 class="d-block">{{ $guru->guru['kode_guru'] }}</h6>
                                    <h6 class="d-block">{{ $guru->guru['jenkel_guru'] }} </h6>
                                </div>
                                <div class="ml-auto">
                                ...
                                <div class="tab-content ml-1" id="myTabContent">
                                    <div class="tab-pane fade show active" id="basicInfo" role="tabpanel" aria-labelledby="basicInfo-tab">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-8 col-6">
                                                {{ tgl_indo($guru->guru['tanggal_lahir_guru'])  }}
                                            </div>
                                        </div>
                                        <hr />
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-8 col-6">
                                                {{$guru->guru['no_handphone_guru']}}
                                            </div>
                                        </div>
                                        <hr />
                                        <div class="row">
                                            <div class="col-sm-3 col-md-2 col-5">
                                                <label style="font-weight:bold;">Kategori Kelas</label>
                                            </div>
                                            <div class="col-md-8 col-6">
                                                {{$data_guru->categoryKelas->nama_category_kelas}}
                                            </div>
                                        </div>
                                        <hr />
                                        <div class="row">
                                            <div class="col-sm-3 col-md-2 col-5">
                                                <label style="font-weight:bold;">Mate Pelajaran</label>
                                            </div>
                                            <div class="col-md-8 col-6">
                                                {{$data_guru->mataPelajaran->mata_pelajaran}}
                                            </div>
                                        </div>
                                        <hr />
