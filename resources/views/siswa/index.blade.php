@extends('./template') @section('title', 'Data Siswa') @section('css') 
<!-- Custom CSS -->
...
<div class="page-breadcrumb">
	<div class="row">
		<div class="col-12 d-flex no-block align-items-center">
			<h4 class="page-title"><i class="fas fa-database"></i> Data Siswa</h4>
				...
				<tbody>
                    ...
                    @foreach($data_siswa as $siswa)
                        <tr>
                            ...
                            <td>{{$siswa->email}}</td>
                            <td>{{$siswa->siswa['jenkel_siswa']}}</td>
                            <td>
                                ...
                                @else
                                    ...
                                    @elseif($siswa->siswa['jenkel_siswa'] == 'Wanita')
                            ...
                            <td align="center">
                                <div class="box-button">
                                    <a href="{{ url('siswa/edit/'. $siswa->id) }}" class="btn btn-primary"><i class="fas fa-edit"></i></a>
                                </div>
                                @if(isset($siswa->siswa['user_id']))
                                    <div class="box-button">
                                        <a href="{{ url('siswa/show/'. $siswa->id) }}" class="btn btn-success"><i class="fas fa-eye"></i></a>
                                    </div>
                                    <div class="box-button">
                                        <a href="{{ url('siswa/destroy/'. $siswa->id) }}" class="btn btn-danger confirm_delete"><i class="fas fa-trash"></i></a>
                                    </div>
                                @endif
                            </td>
                        </tr>
