@extends('./template') @section('title', 'Detail Siswa') @section('css') 
<!-- Custom CSS -->
...
<div class="page-breadcrumb">
	<div class="row">
		<div class="col-12 d-flex no-block align-items-center">
			<h4 class="page-title"><i class="fas fa-user"></i> Detail Siswa</h4>
                        ...
                        <div class="card-title mb-4">
                            <div class="d-flex justify-content-start">
                                <div class="image-container">
                                    @if(isset($siswa->siswa['foto_siswa']))
                                        <img src="{{ asset('fotosiswa/'. $siswa->siswa['foto_siswa']) }}" id="imgProfile" style="width: 150px; height: 150px" class="img-thumbnail" />
                                    @else
                                        @if($siswa->siswa['jenkel_siswa'] == 'Pria')
                                            <img src="{{ asset('fotosiswa/male.png') }}" id="imgProfile" style="width: 150px; height: 150px" class="img-thumbnail" />
                                        @else
                                            <img src="{{ asset('fotosiswa/female.png') }}" id="imgProfile" style="width: 150px; height: 150px" class="img-thumbnail" />
                                        @endif
                                    @endif
                                </div>
                                <div class="userData ml-3">
                                    <h2 class="d-block" style="font-size: 1.5rem; font-weight: bold">{{ $siswa->nama }}</h2>
                                    <h6 class="d-block">{{ $siswa->siswa['kode_siswa'] }}</h6>
                                    <h6 class="d-block">{{ $siswa->siswa['jenkel_siswa'] }} </h6>
                                </div>
                                <div class="ml-auto">
                                ...
                                <div class="tab-content ml-1" id="myTabContent">
                                    <div class="tab-pane fade show active" id="basicInfo" role="tabpanel" aria-labelledby="basicInfo-tab">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-8 col-6">
                                                {{ tgl_indo($siswa->siswa['tanggal_lahir_siswa'])  }}
                                            </div>
                                        </div>
                                        <hr />
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-8 col-6">
                                                {{$siswa->siswa['no_handphone_siswa']}}
                                            </div>
                                        </div>
                                        <hr />
                                    ...
                                    <div class="tab-pane fade" id="connectedServices" role="tabpanel" aria-labelledby="ConnectedServices-tab">
                                        <div class="row">
                                            <div class="col-sm-3 col-md-2 col-5">
                                                <label style="font-weight:bold;">Kode Siswa</label>
                                            </div>
                                            <div class="col-md-8 col-6">
                                                {{$siswa->siswa['kode_siswa']}}
                                            </div>
                                        </div>
                                        <hr/>
                                        <div class="row">
